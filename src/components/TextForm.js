        ...
        <div>
            <>
                <div className="mb-3" style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
                    ...
                    <button disabled={text.length===0} className="btn btn-success mt-3 ms-2" onClick={handleLoClick}>Convert to Lowercase</button>
                    <button disabled={text.length===0} className="btn btn-warning mt-3 ms-2" onClick={handleClearClick}>Clear Text</button>
                </div>
